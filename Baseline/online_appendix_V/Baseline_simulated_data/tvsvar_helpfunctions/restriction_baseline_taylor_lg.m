function [St_old, DCDhalft_old] = restriction_baseline_taylor_lg(B_old_t, ddelta_t, ggamma_t, Q_t, t)
...
if cond_ssigma_old<10000
    ...
    sign_indicator_ffr2 = (res_to_p(hrz_impose)<10) * (res_to_p(hrz_impose)>1); % taylor principle
