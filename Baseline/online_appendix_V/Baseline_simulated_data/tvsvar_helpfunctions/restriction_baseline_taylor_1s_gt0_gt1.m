function [St_old, DCDhalft_old] = restriction_baseline_taylor_1s_gt0_gt1(B_old_t, ddelta_t, ggamma_t, Q_t, t)
...
if cond_ssigma_old<10000
    ...
    sign_indicator_zlb0  = (L0(3,1)>0)*(L0(2,1)<0);
    sign_indicator_zlb1  = (L0(3,1)>0)*(L0(2,1)<0);
    sign_indicator_zlb2  = (L0(3,1)>0)*(L0(2,1)<0);
    ...
    sign_indicator_ffr1 = (At(1,1)<0)*(At(2,1)<0)*(At(3,1)>0)*(L0(3,1)>0)*(L0(2,1)<0)*(ppsi_y<4)*(ppsi_p<4);
    ...
    St_old = ( (sum(ttime(t)==ttime_ffr1)==1 && sign_indicator_ffr==1) ...
