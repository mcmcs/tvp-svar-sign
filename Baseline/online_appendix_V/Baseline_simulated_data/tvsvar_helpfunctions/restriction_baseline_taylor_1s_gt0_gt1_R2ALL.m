function [St_old, DCDhalft_old] = restriction_baseline_taylor_1s_gt0_gt1_R2ALL(B_old_t, ddelta_t, ggamma_t, Q_t, t)
...
ttime_ffr1 = [1969.75:0.25:1983.75];
 
ttime_ffr2 = [1984.00:0.25:2023.25];
...
%         || (sum(ttime(t)==ttime_zlb2)==1 && sign_indicator_zlb2==1)); % first shock and systematic
    ...
    St_old = ( (sum(ttime(t)==ttime_ffr1)==1 && sign_indicator_ffr==1) ...
        || (sum(ttime(t)==ttime_ffr2)==1 && sign_indicator_ffr3==1)); % first shock and systematic
