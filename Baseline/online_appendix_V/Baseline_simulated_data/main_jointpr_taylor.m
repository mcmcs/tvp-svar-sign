...
% -------------------------------------------------------------------------
% Restrictions:
type_restriction = 115;%; % 0 unrestricted, 115 baseline
...
if type_restriction == 0
    ...
    %% Posterior mean
    load('temp_results_unrest_ndraws_50000_is_restrict_B0.mat', 'mat_B', 'mat_ddelta', 'mat_ggamma', 'mat_Vd', 'mat_Vg', 'mat_VB');
...
% setting
M0           = 200000;          % number of MCMC draws
