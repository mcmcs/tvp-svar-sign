...
% _R2ALL: imposing restrictions all period
...
% -------------------------------------------------------------------------
% Restrictions:
type_restriction = 118; % 0 unrestricted, 1 baseline, 2 tyalor
...
switch type_restriction
    ...
    case 117
        function_restrictions = @restriction_baseline_taylor_1s_tv;
        is_restrict_B = true; %true if restriction includes B

    case 118
        function_restrictions = @restriction_baseline_taylor_1s_gt0_gt1_R2ALL;
        is_restrict_B = true; %true if restriction includes B
...
if type_restriction == 0
    ...
    load(['results',filesep,'temp_results_jointpr_rest113r202ndraws100000.mat'], 'mat_B', 'mat_ddelta', 'mat_ggamma', 'mat_Vd', 'mat_Vg', 'mat_VB');
...
% setting
M0           = 500000;          % number of MCMC draws
