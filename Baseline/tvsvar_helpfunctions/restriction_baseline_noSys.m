function [St_old, DCDhalft_old] = restriction_baseline_noSys(B_old_t, ddelta_t, ggamma_t, Q_t, t)
% checking sign restrictions

% noSys: no systematic restrictions
...
sign_indicator_ffr   = (L0(3,1)>0)*(L0(4,1)<0)*(L0(2,1)<0) ;
