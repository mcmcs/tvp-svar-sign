function [St_old, DCDhalft_old] = restriction_baseline_2shocks_taylor1s(B_old_t, ddelta_t, ggamma_t, Q_t, t)
...
if cond_ssigma_old<10000
    ...
    sign_indicator_ffr1 = (At(1,1)<0)*(At(2,1)<0)*(At(3,1)>0)*(At(5,1)>0)*(L0(3,1)>0)*(L0(4,1)<0)*(L0(2,1)<0)*(ppsi_y<4)*(ppsi_p<4)*(ppsi_cs>-4);
    sign_indicator_ffr2 = (res_to_p(hrz_impose)>1); % taylor principle
