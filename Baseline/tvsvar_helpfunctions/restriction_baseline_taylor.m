function [St_old, DCDhalft_old] = restriction_baseline_taylor(B_old_t, ddelta_t, ggamma_t, Q_t, t)
...
if cond_ssigma_old<10000
    ...
    sign_indicator_ffr2 = (res_to_p(hrz_impose)<4) * (res_to_p(hrz_impose)> 0); % taylor principle
