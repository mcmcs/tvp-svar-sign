function [B_old, ntry_old] = draw_B_single_move3tmp(y_old, x_old, B_old, ddelta_old, ggamma_old, Q_old, VB_old, bbet_hat, bbet_hat_Vinv, function_restrictions)
...
%     DCD_t1 = Dt_old*Ct_old*Dt_old;
    ...
    [bbet_old, ~, n_try] = slice_sampling_v02(slice, z_old, lik_old);
